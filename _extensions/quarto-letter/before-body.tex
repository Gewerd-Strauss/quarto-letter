...
\setkomavar{fromname}{\flushright\normalfont\textbf{$sender.firstline$}}
...
$if(english)$
File number:\quad\ $sender.filenumber$\\
$else$
$sender.filenumber-name$:\quad\ $sender.filenumber$\\
$endif$
$endif$
$if(english)$
Date:\quad $date$}
...
\makeatletter
  ...
  \@addtoplength{locwidth}{75mm} % width of ABSENDERbox
